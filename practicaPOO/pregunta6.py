...
## Cambio aca
archivo2 = open("registro.txt","w") # cambio
...
# Estado ciudades normales y dañadas
cnt = 0
cnt_d = 0
for elem in A.mapa:
    for elem2 in elem:
        if elem2:
            ...
            if elem2.vida < 100:
                cnt_d +=1
archivo2.write("Tu civilizacion cuenta con "+str(cnt)+" ciudades, de las cuales "+str(cnt_d)+" se encuentran con danos\n")
...
if A.oro and A.soldados and A.tecnologia and A.proteccion and A.moral:
    ...
    archivo2.write("A la edad de "+str(A.edad)+ "inviernos: La civilizacion se ha mantenido firme hasta la actualidad")
else:
    print(A.nombre, "cayo")
    archivo2.write("A la edad de "+str(A.edad)+" inviernos: La civilizacion cayo")
